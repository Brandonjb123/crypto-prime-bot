    ...
    keyboard = [
        [
            ...
            InlineKeyboardButton(
                "📊 Chart", url=f"https://www.tradingview.com/chart/?symbol={tv_symbol}"
            ),
        ],
        [
            InlineKeyboardButton("📡 Scan Market", callback_data="menu_scan"),
...
def pair_selection_keyboard() -> InlineKeyboardMarkup:
    keyboard = []
    row = []
    for _, pair in enumerate(POPULAR_PAIRS):
    ...
    keyboard.append([InlineKeyboardButton("✏️ Ketik Pair Lain", callback_data="analyze_custom")])
...
def price_pair_selection_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard.append([InlineKeyboardButton("✏️ Ketik Pair Lain", callback_data="price_custom")])
    keyboard.append([InlineKeyboardButton("🏠 Menu Utama", callback_data="menu_start")])
    return InlineKeyboardMarkup(keyboard)
