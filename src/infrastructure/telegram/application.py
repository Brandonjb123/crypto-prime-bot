...
class TelegramApplication:
    ...
    def build(self) -> None:
        ...
        self.app.add_handler(CommandHandler("signals", self.bot.handle_update))
        self.app.add_handler(CommandHandler("history", self.bot.handle_update))
        self.app.add_handler(CommandHandler("trackrecord", self.bot.handle_update))
        self.app.add_handler(CommandHandler("subscribe", self.bot.handle_update))
        self.app.add_handler(CommandHandler("checkout", self.bot.handle_update))
        self.app.add_handler(CommandHandler("terms", self.bot.handle_update))
        self.app.add_handler(CommandHandler("privacy", self.bot.handle_update))
        self.app.add_handler(CommandHandler("risk", self.bot.handle_update))
        self.app.add_handler(CommandHandler("substatus", self.bot.handle_update))
