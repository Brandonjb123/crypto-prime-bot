...
def _make_snapshot(price=50000.0, atr=1000.0) -> AnalysisSnapshot:
    return AnalysisSnapshot(
        ...
        technical=TechnicalAnalysis(ema20=50000.0, ema50=48000.0, rsi14=60.0, atr14=atr, timestamp=datetime.now(UTC)),
        ...
        volatility=VolatilityAnalysis(atr=atr, atr_normalized=2.0, risk_level="MEDIUM", confidence_score=1.0, timestamp=datetime.now(UTC)),
